...
dialModeAnim = 1;					-- 1 for Milky Way and 2 for Pegasus gate animations
...
symbolColour =    {[true] = "Smoky grey",				[false] = "Smoky grey"};  -- true when gate is active, false otherwise
symbolMat =       {[true] = Enum.Material.Metal,		[false] = Enum.Material.Metal};

chevColour =      {[true] = "Br. reddish orange",		[false] = Color3.fromRGB(85, 35, 35)};
chevRefl =        {[true] = 0.4, 						[false] = 0};
chevTrans =       {[true] = 0,							[false] = 0.23};
chevMat =         {[true] = Enum.Material.Neon,			[false] = Enum.Material.Glass};

lightColour =     {[true] = "Br. reddish orange", 		[false] = Color3.fromRGB(66, 37, 21)};
...
ringRotationSpeed = 3;				-- # steps it takes to rotate to the next symbol (lower is faster, must be > 0)
